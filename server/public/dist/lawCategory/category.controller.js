...
let CategoryController = class CategoryController {
    ...
    async create(createLawCategoryDto) {
        try {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_category_dto_1.CreateLawCategoryDto]),
...
__decorate([
    (0, common_1.Get)('findBy/:part_id'),
    __param(0, (0, common_1.Param)('part_id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], CategoryController.prototype, "findBy", null);
__decorate([
    (0, common_1.Get)(':id'),
